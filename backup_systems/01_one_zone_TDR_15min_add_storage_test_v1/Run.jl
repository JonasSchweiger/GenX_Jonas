...
netrev = [netrevenue[!,6]+netrevenue[!,7]+netrevenue[!,8] netrevenue[!,9] netrevenue[!,10]+netrevenue[!,11]+netrevenue[!,12] netrevenue[!,13] netrevenue[!,14]+netrevenue[!,16] netrevenue[!,15] netrevenue[!,18] netrevenue[!,21]]
...
emm_plot  |>@vlplot(mark={:line},
    ...
    # Read all NetRevenue files
netrevenue_files = ["NetRevenue.csv", "NetRevenue1.csv", "NetRevenue2.csv", "NetRevenue3.csv"]
netrevenues = [CSV.read(joinpath(case,"results",file),DataFrame,missingstring="NA") for file in netrevenue_files]
